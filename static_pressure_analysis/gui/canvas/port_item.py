...
class PortItem(QGraphicsEllipseItem):
    ...
    def __init__(self, direction: str, parent_node_item):
        """
        Args:
            direction: "inlet" or "outlet"
            parent_node_item: the NodeItem that owns this port
        """
        ...
        self.setZValue(2)
        self.setToolTip("Outlet — drag to connect" if self._is_outlet
                        else "Inlet — drop connection here")
